...
Servo myservo1; // creates servo object
Servo myservo2; // creates servo object
...
#define SERVO_PIN_1 9 // use pin 9 for servo control
#define SERVO_PIN_2 11 // use pin 11 for servo control
...
void fileConfig(void)
{
  ...
  dataFile.print("X");
  dataFile.print("\tY_PID_Input");
  dataFile.print("\tZ_PID_Input");
  dataFile.print("\tSetpoint_PID");
  dataFile.print("\tServo1_PID_Output");
  dataFile.print("\tServo2_PID_Output");
...
void setup(void)
{
  ...
  myservo1.write(90); // starts servo at home position of 90deg

  myservo2.attach(SERVO_PIN_2);
  myservo2.write(90); // starts servo at home position of 90deg
...
void loop(void)
{
  ...
  for (int counter = 0; counter < 200; counter++)
  {
    ...
    dataFile.print("\t");
    dataFile.print(output_1, 3);
    dataFile.print("\t");
    dataFile.print(output_2, 3);
    dataFile.print("\t");
    dataFile.print(temp);
    dataFile.print("\t");
